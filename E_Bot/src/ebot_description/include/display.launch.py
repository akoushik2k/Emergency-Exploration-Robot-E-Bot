...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'azure_description.urdf'
    xacro_file = "azure_description.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "azure_description"
    use_urdf = False
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("azure_description"), "rviz", "display_default.rviz"]
    )
